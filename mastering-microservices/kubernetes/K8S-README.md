...
```
$ docker image tag gateway masteringmicroservicerf/gateway
$ sudo docker push masteringmicroservicerf/gateway
$ docker image tag invoice masteringmicroservicerf/invoice
$ sudo docker push masteringmicroservicerf/invoice
$ docker image tag notification masteringmicroservicerf/notification
$ sudo docker push masteringmicroservicerf/notification
```
