...
describe('Invoice e2e test', () => {
  ...
  const invoiceSample = {
    date: '2022-01-26T22:07:57.741Z',
    status: 'ISSUED',
    paymentMethod: 'CASH_ON_DELIVERY',
    paymentDate: '2022-01-27T09:06:30.319Z',
    paymentAmount: 75679,
  };
  ...
  describe('new Invoice page', () => {
    ...
    it('should create an instance of Invoice', () => {
      cy.get(`[data-cy="date"]`).type('2022-01-26T23:06').should('have.value', '2022-01-26T23:06');
      ...
      cy.get(`[data-cy="paymentDate"]`).type('2022-01-26T18:22').should('have.value', '2022-01-26T18:22');
