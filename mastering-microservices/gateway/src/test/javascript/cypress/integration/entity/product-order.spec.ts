...
describe('ProductOrder e2e test', () => {
  ...
  const productOrderSample = { placedDate: '2022-01-26T21:35:28.728Z', status: 'COMPLETED', code: 'paradigm Account adapter' };
  ...
  describe('new ProductOrder page', () => {
    ...
    it('should create an instance of ProductOrder', () => {
      cy.get(`[data-cy="placedDate"]`).type('2022-01-27T03:57').should('have.value', '2022-01-27T03:57');
