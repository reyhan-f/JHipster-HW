...
describe('Notification e2e test', () => {
  ...
  const notificationSample = {
    date: '2022-01-27T01:25:40.480Z',
    sentDate: '2022-01-26T17:38:43.824Z',
    format: 'PARCEL',
    userId: 94565,
    productId: 69326,
  };
  ...
  describe('new Notification page', () => {
    ...
    it('should create an instance of Notification', () => {
      cy.get(`[data-cy="date"]`).type('2022-01-26T09:43').should('have.value', '2022-01-26T09:43');

      cy.get(`[data-cy="details"]`).type('calculate').should('have.value', 'calculate');

      cy.get(`[data-cy="sentDate"]`).type('2022-01-26T09:48').should('have.value', '2022-01-26T09:48');
